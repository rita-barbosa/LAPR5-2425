...
{
    public class CreateSpecializationIntegrationTest
    {
        ...
        public CreateSpecializationIntegrationTest()
        {
        ...
        [Fact]
        public async Task CreateSpecialization_Returns_CreatedResult_ControllerService()
        {
             //Arrage
        ...
        [Fact]
        public async Task CreateSpecialization_Returns_CreatedResult_ServiceDomain()
        {
            //Arrage
            var dtoMock = new SpecializationDto{Code = "10101000", Denomination = "orthopaedics", Description = "The treatment or study of bones that have not grown correctly or that have been damaged."};
            var context = new DefaultHttpContext();
            ...
            Assert.Equal(result.Denomination, dtoMock.Denomination);
            _repoMock.Verify(r => r.AddAsync(It.IsAny<Specialization>()), Times.Once);
