...
#
root@vs251:/etc# cd ..
root@vs251:/# cd /scripts/
root@vs251:/scripts# ls
deployment_script.sh       packages-microsoft-prod.deb
deployment_script.sh.save  validate_mdbackoffice.sh
install_dotnet.sh          validate_mdbackoffice.sh.save
root@vs251:/scripts# cat validate_mdbackoffice.sh
#!/bin/bash
